...
export function ConditionBuilder({ conditions, onConditionsChange }: ConditionBuilderProps) {
  ...
  const getConditionIcon = (type: SellCondition['type']) => {
    const config = conditionTypes.find((t) => t.value === type);
    return (config?.icon || DollarSign) as React.ComponentType<{ className?: string }>;
  };

  const getConditionUnit = (type: SellCondition['type']) => {
    const config = conditionTypes.find((t) => t.value === type);
    return config?.unit || '';
  };
        ...
        <AnimatePresence>
          {conditions.length === 0 ? (
            <div className="text-center py-8 text-gray-400">
              ...
              <p className="text-sm mt-2">Add conditions to automate your selling strategy</p>
            </div>
          ) : (
                      ...
                      <div className="flex-1 grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value: SellCondition['type']) =>
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value: SellCondition['operator']) =>
