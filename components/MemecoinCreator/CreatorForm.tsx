...
export function CreatorForm() {
  ...
  const setLastCreatedTokenAddress = useSettingsStore((state) => state.setLastCreatedTokenAddress);
  ...
  async function onSubmit(data: CreatorFormValues) {
    ...
    if (
      ...
      (!data.solAmount || data.solAmount <= 0 || !data.tokenAmount || data.tokenAmount <= 0)
    ) {
    ...
    try {
      ...
      toast.success('Token created successfully!', {
        ...
        action: {
          ...
          onClick: () => window.open(`https://solscan.io/token/${result.tokenAddress}`, '_blank'),
        },
      });
    ...
    <div className="space-y-6">
      <TokenLibrary
        onPick={(t) => {
          ...
          if (t.website) form.setValue('website', t.website);
          if (t.twitter) form.setValue('twitter', t.twitter);
          if (t.description) form.setValue('description', t.description);
        }}
      />
