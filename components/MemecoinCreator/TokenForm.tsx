...
type Mode = 'regular' | 'instant' | 'delayed' export default function T o kenForm() {
  ...
  } return ( <Card> <CardHeader> <CardTitle> Create Token </CardTitle> </CardHeader> <CardContent className ="grid gap - 3, md:grid - cols-2"> <div className =", md:col - span-2"> <Label> Platform </Label> <select className ="w - full rounded - md border bg - background p-2" value ={platform} on Change ={(e) => s e tPlatform(e.target.value as Platform)
  ...
  } <div className =", md:col - span-2"> <Label> Image URL </Label> <Input value ={image} on Change ={(e) => s e tImage(e.target.value)
  ...
  }/> </div> <div className =", md:col - span-2"> <Label> Description </Label> <Input value ={desc} on Change ={(e) => s e tDesc(e.target.value)
  }/> </div> <div className =", md:col - span-2"> <Button onClick ={onSubmit}> Create </Button> </div> </CardContent> </Card> )
  }
