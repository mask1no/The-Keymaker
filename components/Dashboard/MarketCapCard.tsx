        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            >
              ...
              <div className="font-semibold text-sm">{formatCurrency(tokenData.fdv)}</div>
            </div>
            ...
            >
              ...
              <div className="font-semibold text-sm">{formatCurrency(tokenData.volume24h)}</div>
            </div>
            ...
            >
              ...
              <div className={`font-semibold text-sm ${isPositive ? 'text-green-500' : 'text-red-500'}`}>
