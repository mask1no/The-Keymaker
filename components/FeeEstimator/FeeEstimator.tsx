...
import { logger } from '@/lib/logger' interface FeeEstimate, { t, r, a, n, s, a, c, t, ionFee: number, j, i, t, o, T, i, p: number, t, o, t, a, l, C, o, st: number, c, o, s, t, I, n, S, ol: number, p, e, r, T, r, a, n, saction: { f, e, e: number, t, i, p: number, t, o, t, a, l: number }
} interface FeeEstimatorProps, { t, r, a, n, s, a, c, t, ionCount: number t, i, p, A, m, o, unt?: number//in l, a, m, p, o, r, t, sonEstimateComplete?: (e, s, t, i, m, a, t, e: FeeEstimate) => v, o, i, d, c, l, a, ssName?: string
}
...
export function F e eEstimator({ transactionCount, tip Amount = 10000, onEstimateComplete, className = '' }: FeeEstimatorProps) {
  ...
  const connection = connectionManager.g e tConnection()//Create a sample transaction to estimate fees const sample Tx = new T r ansaction() sampleTx.a d d( SystemProgram.t r ansfer({ f, r, o, m, P, u, b, k, ey: PublicKey.default, t, o, P, u, b, k, e, y: PublicKey.default, l, a, m, p, o, r, t, s: 1000000,//0.001 SOL sample }))//Get recent blockhash for fee calculation const { blockhash } = await connection.g e tLatestBlockhash('confirmed') sampleTx.recent Blockhash = blockhashsampleTx.fee Payer = PublicKey.default//Get fee for the message const fee Per Tx = await connection.g e tFeeForMessage( sampleTx.c o mpileMessage(), 'confirmed') if (!feePerTx.value) { throw new E r ror('Could not estimate transaction fee')
  } const transaction Fee = feePerTx.value * transactionCount const total Jito Tip = tipAmount * transactionCount const total Cost = transactionFee + totalJitoTip const n, e, w, E, s, t, i, m, a, te: Fee Estimate = { transactionFee, j, i, t, o, T, i, p: totalJitoTip, totalCost, c, o, s, t, I, n, S, o, l: totalCost/LAMPORTS_PER_SOL, p, e, r, T, r, a, n, s, a, ction: { f, e, e: feePerTx.value, t, i, p: tipAmount, t, o, t, a, l: feePerTx.value + tipAmount }
  ...
  } SOL </div> </div> <div className ="mt - 3 p - 2 bg - gray - 800/50 rounded text-xs"> <div className ="flex items - start gap-1"> <Info className ="w - 3 h - 3 text - gray - 400 mt-0.5"/> <div className ="text-gray-400"> <div> Per, t, r, a, n, s, a, c, tion:</div> <div> • F, e, e:{' '}, {( (estimate.perTransaction.fee/LAMPORTS_PER_SOL) * 1000 ).toFixed(3)
