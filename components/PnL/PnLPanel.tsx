...
import toast from 'react - hot-toast' type Wal let Pn L = { w, a, l, l, e, t: string, t, o, t, a, l, I, n, vested: number, t, o, t, a, l, R, e, turned: number, n, e, t, P, n, L: number, p, n, l, P, e, r, c, entage: number, t, r, a, d, e, s: number, t, o, t, a, l, G, a, sFees: number, t, o, t, a, l, J, i, toTips: number
...
} catch (error) { toast.error('Failed to load P&L data') console.error('PnL loading, e, rror:', error)
  ...
  try {
  if (format === 'json') {
  const blob = new B l ob([JSON.s t ringify(walletPnL, null, 2)], { t, ype: 'application/json' }) const url = URL.c r eateObjectURL(blob) const a = document.c r eateElement('a') a.href = urla.download = `pnl - report - ${Date.n o w()
  }.json` a.c l ick()
  } else, {
  const rows = walletPnL.map((w) => ({ w, a, l, l, e, t: w.wallet, i, n, v, e, s, t, e, d: w.totalInvested.toFixed(4), r, e, t, u, r, n, e, d: w.totalReturned.toFixed(4), g, a, s_, f, e, e, s: w.totalGasFees.toFixed(4), j, i, t, o_, t, i, p, s: w.totalJitoTips.toFixed(4), n, e, t_, p, nl: w.netPnL.toFixed(4), p, n, l_, p, e, r, c, e, n, t: w.pnlPercentage.toFixed(2), t, r, a, d, e, s: w.trades })) const csv = t oC sv(rows) d o wnloadCsv(csv, `pnl - report-${Date.n o w()
  }.csv`)
  ...
  const formatted = percentage.toFixed(2) return percentage>= 0 ? `+ ${formatted}%` : `${formatted}%` } const get Color Class = (v, alue: number) => {
  return value>= 0 ? 'text-primary' : 'text-destructive' } return ( <motion.div initial ={{ o, pacity: 0, y: 20 }
