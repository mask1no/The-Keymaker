...
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@/components/UI/tooltip' interface SlippageSettingsProps, { s, l, i, p, p, a, g, e: number, m, a, x, S, l, i, p, page: number, o, n, S, l, i, p, p, ageChange: (v, alue: number) => v, o, i, d, o, n, M, a, x, SlippageChange: (v, alue: number) => void
}
