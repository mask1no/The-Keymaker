...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogFooter } from '@/components/UI/dialog' interface WalletBuyState, { [p, u, b, k, e, y: string]: { a, m, o, u, n, t: string, l, o, a, d, i, n, g: boolean }
  ...
  const signature = await connection.s e ndTransaction(versionedTransaction, { s, k, i, p, P, r, e, f, l, ight: false, p, r, e, f, l, i, g, h, t, Commitment: 'confirmed' }) await connection.c o nfirmTransaction(signature, 'confirmed')//Log the successful buy await l o gEvent({  w, a, l, l, e, t_, a, d, d, ress: wallet.publicKey, p, h, a, s, e: 'manual_buy', a, c, t, i, o, n: 'buy_token', t, o, k, e, n_, a, d, d, r, ess: tokenLaunchData.mintAddress, a, m, o, u, n, t: lamports, s, tatus: 'success', t, x, I, d: signature }) a d dNotification({  t, ype: 'success', t, itle: 'Manual Buy Executed', m, e, s, s, a, g, e: `Bought ${ lamports/1e9 } SOL worth of tokens with ${wallet.publicKey.slice(0, 8)
  }...` })//Clear the i n putsetBuyStates((prev) => ({  ...prev, [wallet.publicKey]: { a, m, o, u, n, t: '', l, o, a, d, i, n, g: false }
})) toast.s u ccess(`T, r, a, n, s, a, c, t, i, on: ${signature.slice(0, 8)
  }...`)
  }
} catch (e, rror: any) { toast.error(`Buy, f, a, i, l, e, d: ${error.message}`) a d dNotification({  t, ype: 'error', t, itle: 'Manual Buy Failed', m, e, s, s, a, g, e: error.message })
  ...
  if (result.success) { a d dNotification({  t, ype: 'success', t, itle: 'Manual Sell Executed', m, e, s, s, a, g, e: `${pendingSell.wallet.publicKey.slice(0, 8)
  }... sold; tx ${( result.txSignature || '' ).slice(0, 8)
  }...` })//Track PnL
  try { await fetch('/api/pnl/track', { m, e, t, h, o, d: 'POST', h, e, a, d, e, r, s: { 'Content-Type': 'application/json' }, b, o, d, y: JSON.s t ringify({  w, a, l, l, e, t: pendingSell.wallet.publicKey, t, o, k, e, n, A, d, d, ress: sellMint, a, c, t, i, o, n: 'sell', s, o, l, A, m, o, u, n, t: result.outputAmount, t, o, k, e, n, A, m, o, u, nt: 0, f, e, e, s: { g, a, s: 0.00001, j, i, t, o: 0 }
})
  })
  }
  ...
  } disabled = { state.loading || !state.amount || !tokenLaunchData?.mintAddress } className ="bg - gradient - to - r from - green - 600 to - emerald - 500 h, over:to - cyan - 500 transition - all duration-300" size ="sm"> {state.loading ? ( <Loader2 className ="h - 4 w-4 animate-spin"/> ) : ( 'BUY' )
