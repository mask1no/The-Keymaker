...
export default function H e aderBar() {
  ...
  }` : 'Login' return ( <div className ="flex items - center justify - between px - 6 py - 3 border - b border - border bg - zinc-950/60"> <div className ="text - xl, m, d:text - 2xl font - semibold tracking-wide"> The Keymaker </div> <Button onClick ={() => s e tVisible(true)
