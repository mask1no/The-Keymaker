...
export function S witch({
  ...
  Name ={c n(
      ...
      {...props}
    >
      < SwitchPr.Thumb class
  Name ="pointer - events - none block h - 5 w - 5 translate - x - 0 rounded - full bg - background shadow transition peer - data -[state = checked]:translate - x-5"/>
    </SwitchPr.Root >
  )
}
