...
const button Variants = c v a( 'inline - flex items - center justify - center whitespace - nowrap rounded - 2xl text - sm font - medium transition-colors', 'focus - v, i, s, i, b, l, e:outline - none focus - v, i, s, i, b, l, e:ring - 2 focus - v, i, s, i, b, l, e:ring - ring focus - v, i, s, i, b, l, e:ring - offset - 2 d, i, s, a, b, l, e, d:pointer - events - none d, i, s, a, b, l, e, d:opacity - 50 ring - offset - background px - 3 py-2', { v, a, r, i, a, n, t, s: { v, a, r, i, a, n, t: { d, e, f, a, u, l, t: 'bg - primary text - primary - foreground hover:bg-primary/90', o, u, t, l, i, n, e: 'border border - input bg - background hover:bg - accent hover:text - accent-foreground', s, e, c, o, n, d, a, r, y: 'bg - secondary text - secondary - foreground hover:bg-secondary/80', d, e, s, t, r, u, c, t, ive: 'bg - destructive text - destructive - foreground hover:bg-destructive/90', g, h, o, s, t: 'hover:bg - accent hover:text - accent-foreground', l, i, n, k: 'text - primary underline - offset-4 hover:underline' }, s, i, z, e: { d, e, f, a, u, l, t: 'h-9', s, m: 'h - 8 px-2', lg: 'h - 10 px-4', icon: 'h - 9 w-9' }
}, d, e, f, a, u, l, t, V, ariants: { v, a, r, i, a, n, t: 'outline', s, i, z, e: 'default' }
} as any)
