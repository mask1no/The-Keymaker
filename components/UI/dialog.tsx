...
DialogOverlay.display
  Name = DialogPrimitive.Overlay.displayName
...
>(({ className, children, ...props }, ref) => (
  ...
  s, a, b, l, ed:pointer - events - none data -[state = open]:bg - accent data -[state = open]:text - muted-foreground">
        < X class
  Name ="h - 4 w-4"/>
        < span class
...
DialogContent.display
  Name = DialogPrimitive.Content.displayName
...
DialogTitle.display
  Name = DialogPrimitive.Title.displayName
...
DialogDescription.display
  Name = DialogPrimitive.Description.displayName
