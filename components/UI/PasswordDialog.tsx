...
export function PasswordDialog({
  ...
  const [strength, setStrength] = useState({ valid: false, score: 0, feedback: [] as string[] });
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                placeholder={mode === 'create' ? 'Enter a strong password' : 'Enter your password'}
                className="pr-10"
                autoFocus
        ...
        {mode === 'unlock' && (
          <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <p className="text-xs text-yellow-800">
              ...
              It's used to derive wallet keys using PBKDF2 with 600,000 iterations.
            </p>
          </div>
        )}
      </DialogContent>
