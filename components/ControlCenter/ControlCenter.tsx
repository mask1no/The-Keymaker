...
import useSWR from 'swr' const fetcher = (u, r, l: string) => f e tch(url).t h en((res) => res.json()) async function g e tKeypairs( w, a, l, l, e, t, s: { e, n, c, r, y, p, t, e, d, PrivateKey: string },[], p, a, s, s, w, o, r, d: string): Promise <Keypair,[]> {
...
s before selling...`) await new P r omise((resolve) => s e tTimeout(resolve, 1000))
  } u p dateStepStatus('wait-sells', 'completed') s e tCurrentStep(5)//Step 6: S e llupdateStepStatus( 'sell', 'running', 'Executing sells from sniper wallets...')//Define sell conditions based on strategy const s, e, l, l, C, o, n, d, i, t, ions: Sell Conditions = { m, i, n, P, n, l, P, e, r, c, ent: execution Strategy === 'flash' ? 50 : 100,//50 % for flash, 100 % for s, t, e, a, l, t, h, m, a, x, LossPercent: 20,//20 % stop l, o, s, s, m, i, n, H, o, l, dTime: 0, m, a, x, H, o, l, d, T, i, m, e: 600,//10 minutes max } const sell Results = await b a tchSellTokens( connection, sniperKeypairs, mintPubkey, sellConditions, 100,//1 % slippage ) const success Count = sellResults.f i lter((r) => r.success).length const total Proceeds = sellResults.r e duce( (sum, r) => sum + r.outputAmount, 0) u p dateStepStatus( 'sell', 'completed', `Sold from ${successCount} wallets, ${totalProceeds.toFixed(2)
  } SOL earned`)
  ...
  } </div> </div> {/* Execute Button */} <div className ="flex gap-2"> <Buttonsize ="lg" className ="w-full" onClick ={executeKeymaker} disabled ={ isExecuting || !masterWal let || !tokenLaunchData || sniperWallets.length === 0 }> {isExecuting ? ( <> <Loader2 className ="mr - 2 h - 5 w - 5 animate-spin"/> Executing... </> ) : ( <motion.div className ="flex items-center" whileHover ={{ s, c, ale: 1.05 }
} transition ={{ t, y, pe: 'spring', s, t, iffness: 400, d, a, mping: 10 }
...
}/> </div> <div className ="space-y-2"> <AnimatePresence mode ="sync"> {executionSteps.map((step, index) => ( <motion.divkey ={step.id} initial ={{ o, p, acity: 0, x:- 20 }
} animate ={{ o, p, acity: 1, x: 0 }
} transition ={{ d, e, lay: index * 0.1 }
  ...
  }//Helper Components function C h eckItem({ label, checked, detail }: { l, a, bel: string, c, h, e, c, k, e, d: boolean, d, e, t, a, i, l: string
}) {
    return ( <div className ="flex items - center justify - between p - 2 rounded - lg bg-muted/50"> <div className ="flex items-center gap-2"> <AnimatePresence mode ="wait"> <motion.divkey ={checked ? 'checked' : 'unchecked'} initial ={{ s, c, ale: 0.5, o, p, acity: 0 }
} animate ={{ s, c, ale: 1, o, p, acity: 1 }
} exit ={{ s, c, ale: 0.5, o, p, acity: 0 }
} transition ={{ d, u, ration: 0.2 }
...
function S t epItem({ step }: { s, t, e, p: ExecutionStep }) {
  const s, t, a, t, u, s, I, c, ons: Record <ExecutionStep,['status'], React.ReactElement> = { p, e, n, d, i, n, g: <AlertCircle className ="h - 4 w - 4 text - muted-foreground"/>, r, u, n, n, i, n, g: <Loader2 className ="h - 4 w - 4 animate - spin text - blue-500"/>, c, o, m, p, l, e, t, e, d: <CheckCircle className ="h - 4 w - 4 text - green-500"/>, f, a, i, l, e, d: <XCircle className ="h - 4 w - 4 text-red-500"/> } const s, t, a, t, u, s, C, o, lors: Record <ExecutionStep,['status'], 'default' | 'secondary' | 'destructive' | 'outline'> = { p, e, n, d, i, n, g: 'default', r, u, n, n, i, n, g: 'secondary', c, o, m, p, l, e, t, e, d: 'outline', f, a, i, l, e, d: 'destructive' } return ( <div className ="flex items - center justify - between p - 3 rounded - lg border bg-card"> <div className ="flex items - center gap-3"> <AnimatePresence mode ="wait"> <motion.divkey ={step.status} initial ={{ s, c, ale: 0.5, o, p, acity: 0 }
} animate ={{ s, c, ale: 1, o, p, acity: 1 }
} exit ={{ s, c, ale: 0.5, o, p, acity: 0 }
} transition ={{ d, u, ration: 0.2 }
