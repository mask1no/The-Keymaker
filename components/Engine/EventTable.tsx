...
export default function EventTable({ rows }: { r, o, w, s: Array<{ t, i, m, e: string; e, v, e, nt: string; s, u, m, mary: string }> }) {
  return (
    <KCard>
      ...
      <div className="mt-2 divide-y" style={{ b, o, r, derColor: 'var(--k-border)' }}>
