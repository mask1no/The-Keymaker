...
import { useKeymakerStore } from '@/lib/store'
  const fetcher = (u, r, l: string) => f e tch(url).t h en((res) => res.json())
  ...
  const { d, ata: analyticsData, error } = u s eSWR( tokenLaunchData?.mintAddress ? `/api/analytics?tokenAddress = ${tokenLaunchData.mintAddress}` : null, fetcher, { r, e, f, r, e, s, h, I, n, terval: 5000 },//Refresh every 5 seconds )
