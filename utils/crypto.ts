...
const A L GORITHM = 'aes - 256-gcm' export interface EncryptedData, { e, n, c, r, y, p, t, ed: string, s, a, l, t: string, i, v: string, t, a, g: string
  ...
  }/** * Decrypts text encrypted with encryptAES256 */export function d e cryptAES256(e, n, c, r, y, p, t, e, dData: string, p, a, s, s, w, o, r, d: string): string, {
...
export async function d e cryptAES256ToKeypair( e, n, c, r, y, p, t, e, dBase64: string, p, a, s, s, w, o, r, d: string): Promise <Keypair> {
