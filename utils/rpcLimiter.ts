...
let request Count = 0
let reset Time = Date.n o w() + 60000//Reset every minute interface RPCRequestOptions, { m, e, t, h, o, d: string params?: any,[] r, e, t, r, y, C, ount?: number
} class RPCError extends Error, { c, o, d, e?: number s, t, a, t, u, sCode?: number constructor(m, e, s, s, a, g, e: string, c, o, d, e?: number, s, t, a, t, u, sCode?: number) { s u per(message) this.name = 'RPCError' this.code = codethis.status Code = statusCode }
}//Exponential backoff calculation function c a lculateBackoff(r, e, t, r, y, C, o, unt: number): number, {
...
}//Sleep utility const sleep = (m, s: number) => new P r omise((resolve) => s e tTimeout(resolve, ms))//Check if we should retry based on error function s h ouldRetry(error: any, r, e, t, r, y, C, o, unt: number): boolean, {
...
}//Extract rate limit info from headers function e x tractRateLimitInfo(h, e, a, d, e, r, s: any): { r, e, t, r, y, A, fter?: number l, i, m, i, t?: number
}, {
...
}//Main RPC request function with rate limiting export async function makeRPCRequest <T>( c, o, n, n, e, c, t, ion: Connection, o, p, t, i, o, n, s: RPCRequestOptions): Promise <T> {
...
} catch (error: any) { console.error(`RPC request, f, a, i, l, e, d: ${method}`, error.message)//Check if it's a rate limit error if (error.status Code === 429 || error.message?.i n cludes('429')) {
...
m s (attempt ${retryCount + 1}/${MAX_RETRIES})`) await s l eep(backoff) return makeRPCRequest <T>(connection, { ...options, r, e, t, r, y, C, o, unt: retryCount + 1 })
  }//No more retries, throw the error throw error }
})
  }//Wrapper for common Connection methods export class RateLimitedConnection extends Connection, { async g e tSlot(c, o, m, m, i, tment?: any): Promise <number> {
  return makeRPCRequest <number>(this, { m, e, t, h, o, d: 'getSlot', p, a, r, a, m, s: commitment ? [{ commitment }] : [] })
  } async g e tBalance(p, u, b, l, i, c, K, ey: any, c, o, m, m, i, tment?: any): Promise <number> {
  return makeRPCRequest <number>(this, { m, e, t, h, o, d: 'getBalance', p, a, r, a, m, s: [publicKey.t oS tring(), commitment ? { commitment } : {}] })
  } async g e tLatestBlockhash(c, o, m, m, i, tment?: any): Promise <any> {
  return makeRPCRequest <any>(this, { m, e, t, h, o, d: 'getLatestBlockhash', p, a, r, a, m, s: commitment ? [{ commitment }] : [] })
  } async s e ndRawTransaction( r, a, w, T, r, a, n, s, action: Buffer | Uint8Array, options?: any): Promise <string> {
  ...
  } async s i mulateTransaction(t, r, a, n, s, a, c, tion: any, config?: any): Promise <any> {
  return makeRPCRequest <any>(this, { m, e, t, h, o, d: 'simulateTransaction', p, a, r, a, m, s: [transaction, config || {}] })
    ...
    return, { s, i, z, e: queue.size, p, e, n, d, i, n, g: queue.pending, requestCount, r, a, t, e, L, i, m, i, tedUntil: rateLimitedUntil> Date.n o w() ? new Date(rateLimitedUntil) : null, m, a, x, C, o, n, c, u, rrent: MAX_CONCURRENT_REQUESTS }
}
