...
export class SubmissionService, {
  constructor( private, r, e, g, i, o, n: 'ffm' | 'ams' | 'ny' | 'tokyo' | 'unknown' = 'ffm') {} async s u bmitAndPoll( t, x, s_, b64: string,[], polls = 20, delay Ms = 1200): Promise <Result <{ b, u, n, d, l, e, I, d: string; l, a, n, d, e, d, S, l, o, t: number | null }>> {
  try {
  const bundle Id = await s e ndBundle(this.region, txs_b64) let l, a, n, d, e, d, S, l, o, t: number | null = null f o r(let i = 0; i <polls; i ++) {
