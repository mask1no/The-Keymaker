...
import, { Result, ok, err } from './ Result' export type Wal let Signer = { p, u, b, l, i, c, K, e, y: P, u, b, l, i, c, K, e, y, s,
  ignTransaction: ( t, x: VersionedTransaction) => Promise < VersionedTransaction >
