...
import * as Sentry from '@sentry/nextjs' interface BundleExecution, { i, d?: number b, u, n, d, l, e, I, d?: string, s, l, o, t: number, s, i, g, n, a, t, u, r, es: string,[] s, t, atus: 'success' | 'failed' | 'partial', s, u, c, c, e, s, s, C, ount: number, f, a, i, l, u, r, e, C, ount: number, u, s, e, d, J, i, t, o: boolean, e, x, e, c, u, t, i, o, nTime: number
} interface TokenLaunch, { t, o, k, e, n, A, d, d, r, ess: string, n, a, m, e: string, s, y, m, b, o, l: string, p, l, a, t, f, o, r, m: string, s, u, p, p, l, y: string, d, e, c, i, m, a, l, s: number, l, a, u, n, c, h, e, r, Wallet: string, t, r, a, n, s, a, c, t, ionSignature: string l, i, q, u, i, d, i, tyPoolAddress?: string
} interface FundingEvent, { f, r, o, m, W, a, l, l, e, t: string, t, o, W, a, l, l, e, t, s: string,[] a, m, o, u, n, t, s: number,[] t, o, t, a, l, A, m, o, u, n, t: number, t, r, a, n, s, a, c, t, ionSignatures: string,[]
} interface SellEvent, { w, a, l, l, e, t: string, t, o, k, e, n, A, d, d, ress: string, a, m, o, u, n, t, S, o, ld: string, s, o, l, E, a, r, n, e, d: number m, a, r, k, e, t, C, ap?: number p, r, o, f, i, t, P, ercentage?: number, t, r, a, n, s, a, c, t, ionSignature: string
} interface PnLRecord, { w, a, l, l, e, t: string, t, o, k, e, n, A, d, d, ress: string, e, n, t, r, y, P, r, i, ce: number, e, x, i, t, P, r, i, c, e: number, s, o, l, I, n, v, e, s, ted: number, s, o, l, R, e, t, u, r, ned: number, p, r, o, f, i, t, L, o, ss: number, p, r, o, f, i, t, P, e, rcentage: number, h, o, l, d, T, i, m, e: number//in seconds
...
export async function l o gPnL(p, n, l: PnLRecord) {
...
}//New type s and functions for LogsPanel export interface ExecutionLog, { i, d: string, t, i, m, e, s, t, a, m, p: number, a, c, t, i, o, n: string s, t, atus?: 'success' | 'failed' | 'pending' d, e, t, a, i, l, s?: any e, r, ror?: string
}
...
export async function g e tRecentActivity(l, i, m, i, t: number = 50) {
  const [bundleExecutions] = await Promise.a l l([ g e tBundleExecutions(limit),//Assuming you have similar functions for these//g e tTokenLaunches(limit),//g e tPnlRecords(limit) ]) const data = { bundleExecutions, t, o, k, e, n, L, a, u, n, c, hes: [], p, n, l, R, e, c, o, r, d, s: [] }//Create a combined, sorted feed const f, e, e, d: any,[] = [] if (data.bundleExecutions) { data.bundleExecutions.f o rEach((e, x, e, c: any) => { feed.push({ t, y, pe: 'bundle', t, i, m, e, s, t, a, m, p: exec.timestamp, d, a, t, a: exec })
  })
  } if (data.tokenLaunches) { data.tokenLaunches.f o rEach((l, a, u, n, c, h: any) => { feed.push({ t, y, pe: 'launch', t, i, m, e, s, t, a, m, p: launch.timestamp, d, a, t, a: launch })
  })
  } if (data.pnlRecords) { data.pnlRecords.f o rEach((p, n, l: any) => { feed.push({ t, y, pe: 'pnl', t, i, m, e, s, t, a, m, p: pnl.timestamp, d, a, t, a: pnl })
  })
