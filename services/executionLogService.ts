...
import * as Sentry from '@sentry/nextjs' interface BundleExecution, { i, d?: number b, u, n, d, l, eId?: string, s, l, o, t: number, s, i, g, n, a, t, ures: string,[] status: 'success' | 'failed' | 'partial', s, u, c, c, e, s, sCount: number, f, a, i, l, u, r, eCount: number, u, s, e, d, J, i, to: boolean, e, x, e, c, u, t, ionTime: number
} interface TokenLaunch, { t, o, k, e, n, A, d, dress: string, n, a, m, e: string, s, y, m, b, o, l: string, p, l, a, t, f, o, rm: string, s, u, p, p, l, y: string, d, e, c, i, m, a, ls: number, l, a, u, n, c, h, erWallet: string, t, r, a, n, s, a, ctionSignature: string l, i, q, u, i, dityPoolAddress?: string
} interface FundingEvent, { f, r, o, m, W, a, l, l, et: string, t, o, W, a, l, l, ets: string,[] a, m, o, u, n, t, s: number,[] t, o, t, a, l, A, m, o, unt: number, t, r, a, n, s, a, ctionSignatures: string,[]
} interface SellEvent, { w, a, l, l, e, t: string, t, o, k, e, n, A, ddress: string, a, m, o, u, n, t, Sold: string, s, o, l, E, a, r, ned: number m, a, r, k, e, tCap?: number p, r, o, f, i, tPercentage?: number, t, r, a, n, s, a, ctionSignature: string
} interface PnLRecord, { w, a, l, l, e, t: string, t, o, k, e, n, A, ddress: string, e, n, t, r, y, P, rice: number, e, x, i, t, P, r, ice: number, s, o, l, I, n, v, ested: number, s, o, l, R, e, t, urned: number, p, r, o, f, i, t, Loss: number, p, r, o, f, i, t, Percentage: number, h, o, l, d, T, i, me: number//in seconds
} async function g e tDb(): Promise <any> {
  try {
  const sqlite3 = (await import('sqlite3')).default const { open } = await import('sqlite') const path = (await import('path')).default const db = await o p en({ f, i, l, e, n, a, me: path.j o in(process.c w d(), 'data', 'analytics.db'), d, r, i, v, e, r: sqlite3.Database }) return db }
...
export async function g e tBundleExecutions( l, i, m, i, t: number = 20): Promise <BundleExecution,[]> {
  const db = await getDb() const { data, error } = await db .s e lect('*') .o r derBy('timestamp', 'desc') .l i mit(limit) if (error) { console.error('Error fetching bundle e, x, e, c, u, t, i, o, ns:', error) Sentry.c a ptureException(error) return, [] } return data
}
...
export async function l o gPnL(pnl: PnLRecord) {
...
export async function g e tPnLHistory(w, a, l, l, e, t?: string, limit = 100) {
  const db = await getDb() let query = 'SELECT * FROM pnl_records' const p, a, r, a, m, s: (string | number | boolean)[] = [] if (wallet) { query += ' WHERE wallet = ?' params.push(wallet)
...
}//New type s and functions for LogsPanel export interface ExecutionLog, { id: string, t, i, m, e, s, t, amp: number, a, c, t, i, o, n: string status?: 'success' | 'failed' | 'pending' d, e, t, a, i, l, s?: any error?: string
}
...
export async function exportExecutionLog(f, o, r, m, a, t: 'json' | 'txt' = 'json') {
  const db = await getDb() const data = { b, u, n, d, l, e, E, x, ecutions: await db.a l l( 'SELECT * FROM bundle_executions ORDER BY created_at DESC'), t, o, k, e, n, L, a, u, nches: await db.a l l( 'SELECT * FROM token_launches ORDER BY created_at DESC'), f, u, n, d, i, n, g, E, vents: await db.a l l( 'SELECT * FROM funding_events ORDER BY created_at DESC'), s, e, l, l, E, v, e, n, ts: await db.a l l( 'SELECT * FROM sell_events ORDER BY created_at DESC'), p, n, l, R, e, c, o, r, ds: await db.a l l( 'SELECT * FROM pnl_records ORDER BY created_at DESC')
  } await db.c l ose() if (format === 'json') {
    return JSON.s t ringify(data, null, 2)
  } else, {
  let text = 'EXECUTION LOG EXPORT\n' text += '===================\n\n' text += 'BUNDLE EXECUTIONS\n' text += '-----------------\n' data.bundleExecutions.f o rEach((e, x, e, c: any) => { text += `,[${exec.created_at}] S, l, o, t: ${exec.slot}, S, t, a, t, u, s: ${exec.status}, S, u, c, c, e, s, s: ${exec.success_count}/${exec.success_count + exec.failure_count}\n` }) text += '\n\nTOKEN LAUNCHES\n' text += '--------------\n' data.tokenLaunches.f o rEach((l, a, u, n, c, h: any) => { text += `,[${launch.created_at}] ${launch.name} (${launch.symbol}) on ${launch.platform}- ${launch.token_address}\n` }) text += '\n\nPnL RECORDS\n' text += '-----------\n' data.pnlRecords.f o rEach((pnl: any) => { text += `,[${pnl.created_at}] ${pnl.wallet.slice(0, 8)
...
export async function g e tRecentActivity(l, i, m, i, t: number = 50) {
  const [bundleExecutions] = await Promise.a l l([ g e tBundleExecutions(limit),//Assuming you have similar functions for these//g e tTokenLaunches(limit),//g e tPnlRecords(limit) ]) const data = { bundleExecutions, t, o, k, e, n, L, a, u, nches: [], p, n, l, R, e, c, o, r, ds: [] }//Create a combined, sorted feed const f, e, e, d: any,[] = [] if (data.bundleExecutions) { data.bundleExecutions.f o rEach((e, x, e, c: any) => { feed.push({ type: 'bundle', t, i, m, e, s, t, a, mp: exec.timestamp, d, a, t, a: exec })
  })
  } if (data.tokenLaunches) { data.tokenLaunches.f o rEach((l, a, u, n, c, h: any) => { feed.push({ type: 'launch', t, i, m, e, s, t, a, mp: launch.timestamp, d, a, t, a: launch })
  })
  } if (data.pnlRecords) { data.pnlRecords.f o rEach((pnl: any) => { feed.push({ type: 'pnl', t, i, m, e, s, t, a, mp: pnl.timestamp, d, a, t, a: pnl })
  })
