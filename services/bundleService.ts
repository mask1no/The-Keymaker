...
export interface ExecutionResult, { b, u, n, d, l, e, _, id: string, s, i, g, n, a, t, ures: string,[] result, s?: any,[] s, l, o, t, T, a, rgeted?: number
}
...
export async function e x ecuteBundle( b, u, n, d, l, e: Bundle, w, a, l, l, e, t: WalletContextState, j, u, p, i, t, e, r: ReturnType <typeof useJupiter>) {
  const { connected, publicKey, signAllTransactions } = wallet if (!connected || !publicKey || !signAllTransactions) { throw new E r ror('Please connect your wallet.')
  } const { getQuote, getSwapTransaction, connection } = jupiter try {
  const b, u, i, l, t, T, r, a, nsactions: VersionedTransaction,[] = [] f o r (const tx of bundle) {
  if (tx.type === 'swap') {
  ...
  } const recipient Pub Key = new P u blicKey(tx.recipient) const lamports = Math.m a x( 1, Math.f l oor(tx.fromAmount * LAMPORTS_PER_SOL)) const transfer Instruction = SystemProgram.t r ansfer({ f, r, o, m, P, u, b, key: publicKey, t, o, P, u, b, k, e, y: recipientPubKey, l, a, m, p, o, r, t, s: lamports }) const { blockhash } = await connection.g e tLatestBlockhash() const message = new T r ansactionMessage({ p, a, y, e, r, K, e, y: publicKey, r, e, c, e, n, t, B, l, ockhash: blockhash, i, n, s, t, r, u, c, t, ions: [transferInstruction] }).c o mpileToV0Message() const transfer Tx = new V e rsionedTransaction(message) builtTransactions.push(transferTx)
  }
  ...
  } try { await fetch('/api/history/record', { m, e, t, h, o, d: 'POST', h, e, a, d, e, r, s: { 'Content-Type': 'application/json' }, b, o, d, y: JSON.s t ringify({ b, u, n, d, l, e, _, id: result.bundle_id, r, e, g, i, o, n: 'ffm', s, i, g, n, a, t, u, res: result.signatures || [], status: 'pending', t, i, p_, s, o, l: 0.00005 })
  })
  }
