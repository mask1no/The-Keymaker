...
export interface ExecutionResult, { b, u, n, d, l, e, _, i, d: string, s, i, g, n, a, t, u, res: string,[] result, s?: any,[] s, l, o, t, T, a, r, geted?: number
}
...
export async function e x ecuteBundle( b, u, n, d, l, e: Bundle, w, a, l, l, e, t: WalletContextState, j, u, p, i, t, e, r: ReturnType <typeof useJupiter>) {
  ...
  const b, u, i, l, t, T, r, a, n, sactions: VersionedTransaction,[] = [] f o r (const tx of bundle) {
  if (tx.type === 'swap') {
  ...
  } try { await fetch('/api/history/record', { m, e, t, h, o, d: 'POST', h, e, a, d, e, r, s: { 'Content-Type': 'application/json' }, b, o, d, y: JSON.s t ringify({ b, u, n, d, l, e, _, i, d: result.bundle_id, r, e, g, i, o, n: 'ffm', s, i, g, n, a, t, u, r, es: result.signatures || [], s, tatus: 'pending', t, i, p_, s, o, l: 0.00005 })
  })
  }
