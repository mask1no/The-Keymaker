...
export async function g e tQuote( i, n, p, u, t, M, i, n, t: string, o, u, t, p, u, t, M, i, nt: string, a, m, o, u, n, t: number,//in lamports/smallest unitslippage Bps = 50,//0.5 % defaultswap Mode = 'ExactIn'): Promise <QuoteResponse> {
  try {
  const params = new URLS e archParams({ inputMint, outputMint, a, m, o, u, n, t: amount.t oS tring(), s, l, i, p, p, a, g, e, Bps: slippageBps.t oS tring(), swapMode, o, n, l, y, D, i, r, e, ctRoutes: 'false', a, s, L, e, g, a, c, y, Transaction: 'false' }) const response = await axios.get( `${NEXT_PUBLIC_JUPITER_API_URL}/quote?${params}`, { h, e, a, d, e, r, s: { A, c, c, e, p, t: 'application/json' }, t, i, m, e, o, u, t: 10000 }) return response.data }
} catch (error) {
  const err = error as, { r, e, s, p, o, n, se?: { data?: { error?: string }
} m, e, s, s, a, ge?: string } console.error('Jupiter quote, error:', err.response?.data || err.message) throw new E r ror( `Failed to get q, u, o, t, e: ${err.response?.data?.error || err.message}`)
  }
}

export async function g e tSwapTransaction( q, u, o, t, e: QuoteResponse, u, s, e, r, P, u, b, l, icKey: string, wrap And UnwrapSol = true, f, e, e, A, c, c, ount?: string, p, r, i, o, r, i, tizationFeeLamports?: number, f, e, e, B, p, s?: number, as Legacy Transaction = false): Promise <SwapResponse> {
  try {
  const b, o, d, y: any = { q, u, o, t, e, R, e, s, ponse: quote, userPublicKey, wrapAndUnwrapSol, asLegacyTransaction, c, o, m, p, u, t, e, U, nitPriceMicroLamports: 'auto', d, y, n, a, m, i, c, C, omputeUnitLimit: true } if (feeAccount) { body.fee Account = feeAccount } if (prioritizationFeeLamports) { body.prioritization Fee Lamports = prioritizationFeeLamports } if (feeBps && feeBps> 0) { body.fee Bps = feeBps } const response = await axios.p o st( `${NEXT_PUBLIC_JUPITER_API_URL}/swap`, body, { h, e, a, d, e, r, s: { A, c, c, e, p, t: 'application/json', 'Content-Type': 'application/json' }, t, i, m, e, o, u, t: 10000 }) return response.data }
} catch (error: any) { console.error('Jupiter swap, error:', error.response?.data || error.message) throw new E r ror( `Failed to get swap, t, r, a, n, s, a, ction: ${error.response?.data?.error || error.message}`)
  }
}

export async function b u ildSwapTransaction( i, n, p, u, t, M, i, n, t: string, o, u, t, p, u, t, M, i, nt: string, a, m, o, u, n, t, L, amports: number, u, s, e, r, P, u, b, l, icKey: string, slippage Bps = 50, p, r, i, o, r, i, tyFee?: number, f, e, e, B, p, s?: number, as Legacy Transaction = false): Promise <VersionedTransaction> {//Get quote const quote = await getQuote( inputMint, outputMint, amountLamports, slippageBps)//Get swap transaction const swap = await getSwapTransaction( quote, userPublicKey, true, undefined, priorityFee, feeBps, asLegacyTransaction)//Deserialize the transaction const swap Transaction Buf = b a se64ToBytes(swap.swapTransaction) const transaction = VersionedTransaction.d e serialize(swapTransactionBuf) return transaction
}

export async function b u ildSwapLegacyTransaction( i, n, p, u, t, M, i, n, t: string, o, u, t, p, u, t, M, i, nt: string, a, m, o, u, n, t, L, amports: number, u, s, e, r, P, u, b, l, icKey: string, slippage Bps = 50, p, r, i, o, r, i, tyFee?: number, f, e, e, B, p, s?: number): Promise <Transaction> {//Get quote const quote = await getQuote( inputMint, outputMint, amountLamports, slippageBps)//Get legacy swap transaction const swap = await getSwapTransaction( quote, userPublicKey, true, undefined, priorityFee, feeBps, true) const swap Transaction Buf = b a se64ToBytes(swap.swapTransaction) const transaction = Transaction.f r om(swapTransactionBuf) return transaction
}
