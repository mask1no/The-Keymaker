...
import, { QuoteResponse, SwapResponse } from '@/ lib / type s' const W S O
  L_MINT = 'So11111111111111111111111111111111111111112' function b a s e64ToBytes(b, a, s, e64: string): Uint8Array, { i f ( typeof Buffer !== 'undefined' && t y p eof (Buffer as any).from === 'function' ) { return Uint8Array.f r o m( (Buffer as unknown as, { f, r, o, m: (s: string, e, n, c: string) => Buffer }).f r o m( base64, 'base64')) } const binary = typeof atob !== 'undefined' ? a t o b(base64) : '' const len = binary.length const bytes = new U i n t8Array(len) f o r (let i = 0; i < len; i ++) bytes,[i] = binary.c h a rCodeAt(i) return bytes
} export async function g e tQ uote( i, n, p, u, t, M, i, n, t: string, o, u, t, p, u, t, M, i, n, t: string, a, m, o, u, n, t: number,// in lamports / smallest unitslippage Bps = 50,// 0.5 % defaultswap Mode = 'ExactIn'): Promise < QuoteResponse > { try, { const params = new URLS e a rchParams({ inputMint, outputMint, a, m, o, u, n, t: amount.t oS t ring(), s, l, i, p, p, a, g, e, B, p, s: slippageBps.t oS t ring(), swapMode, o, n, l, y, D, i, r, e, c, t, R,
  outes: 'false', a, s, L, e, g, a, c, y, T, r, a,
  nsaction: 'false' }) const response = await axios.g et( `$,{NEXT_PUBLIC_JUPITER_API_URL}/ quote?$,{params}`, { h, e, a, d, e, r, s: { A, c, c, e, p, t: 'application / json' }, t, i, m, e, o, u, t: 10000 }) return response.data }
} c atch (error) { const err = error as, { r, e, s, p, o, n, s, e?: { d, a, ta?: { e, r, ror?: string }
} m, e, s, s, a, g, e?: string } console.e rror('Jupiter quote, e, r, r,
  or:', err.response?.data || err.message) throw new E r r or( `Failed to get q, u, o, t, e: $,{err.response?.data?.error || err.message}`) }
} export async function g e tS wapTransaction( q, u, o, t, e: QuoteResponse, u, s, e, r, P, u, b, l, i, c, K,
  ey: string, wrap And Unwrap
  Sol = true, f, e, e, A, c, c, o, u, nt?: string, p, r, i, o, r, i, t, i, zationFeeLamports?: number, f, e, e, B, p, s?: number, as Legacy Transaction = false): Promise < SwapResponse > { try, { const b, o, d, y: any = { q, u, o, t, e, R, e, s, p, o, n,
  se: quote, userPublicKey, wrapAndUnwrapSol, asLegacyTransaction, c, o, m, p, u, t, e, U, n, i, t,
  PriceMicroLamports: 'auto', d, y, n, a, m, i, c, C, o, m, p,
  uteUnitLimit: true } i f (feeAccount) { body.fee Account = feeAccount } i f (prioritizationFeeLamports) { body.prioritization Fee Lamports = prioritizationFeeLamports } i f (feeBps && feeBps > 0) { body.fee Bps = feeBps } const response = await axios.p o s t( `$,{NEXT_PUBLIC_JUPITER_API_URL}/ swap`, body, { h, e, a, d, e, r, s: { A, c, c, e, p, t: 'application / json', 'Content - Type': 'application / json' }, t, i, m, e, o, u, t: 10000 }) return response.data }
} c atch (e, r, r,
  or: any) { console.e rror('Jupiter swap, e, r, r,
  or:', error.response?.data || error.message) throw new E r r or( `Failed to get swap, t, r, a, n, s, a, c, t, i,
  on: $,{error.response?.data?.error || error.message}`) }
} export async function b u i ldSwapTransaction( i, n, p, u, t, M, i, n, t: string, o, u, t, p, u, t, M, i, n, t: string, a, m, o, u, n, t, L, a, m, p,
  orts: number, u, s, e, r, P, u, b, l, i, c, K,
...
} export async function b u i ldSwapLegacyTransaction( i, n, p, u, t, M, i, n, t: string, o, u, t, p, u, t, M, i, n, t: string, a, m, o, u, n, t, L, a, m, p,
  orts: number, u, s, e, r, P, u, b, l, i, c, K,
