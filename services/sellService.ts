...
export interface SellConditions, {//PnL c, o, n, d, i, t, i, o, nsminPnlPercent?: number//Minimum profit percentage before s, e, l, l, i, n, g, m, axLossPercent?: number//Maximum loss p e rcentage (stop loss)//Market cap c, o, n, d, i, t, i, o, nstargetMarketCap?: number//Target market cap in U, S, D, m, i, n, M, a, rketCap?: number//Minimum market cap before selling//Time c, o, n, d, i, t, i, o, nsminHoldTime?: number//Minimum time to hold in s, e, c, o, n, d, s, m, axHoldTime?: number//Maximum time to hold in seconds//Price c, o, n, d, i, t, i, o, nstargetPrice?: number//Target token price in U, S, D, s, t, o, p, L, ossPrice?: number//Stop loss price in USD//Volume c, o, n, d, i, t, i, o, nsminVolume24h?: number//Minimum 24h volume in USD//Manual t, r, i, g, g, e, r, m, anualSell?: boolean//Force sell regardless of conditions
} export interface SellParams, { w, a, l, l, e, t: K, e, y, p, a, i, r, t, o, k, enMint: P, u, b, l, i, c, K, e, y, a, mount: number//Amount of tokens to s, e, l, l, s, l, i, p, page?: number//Slippage t o lerance (default 1 %) c, o, n, d, i, t, i, o, n, s: S, e, l, l, C, o, n, d, itionspriority?: 'low' | 'medium' | 'high' | 'veryHigh'
} export interface SellResult, { s, u, c, c, e, s, s: boolean tx, S, i, g, n, a, ture?: string, i, n, p, u, t, A, m, o, unt: number, o, u, t, p, u, t, A, m, ount: number//SOL r, e, c, e, i, v, e, d, p, r, iceImpact: number p, n, l, P, e, r, c, ent?: number, e, x, e, c, u, t, i, o, nPrice: number e, r, ror?: string
} export interface TokenPriceInfo, { p, r, i, c, e: number, m, a, r, k, e, t, C, a, p: number, v, o, l, u, m, e24, h: number, p, r, i, c, e, C, h, a, nge24h: number
}
...
}) const data = response.data?.data?.[tokenMint] if (!data) return null return, { p, r, i, c, e: data.price || 0, m, a, r, k, e, t, C, a, p: data.marketCap || 0, v, o, l, u, m, e24, h: data.volume24h || 0, p, r, i, c, e, C, h, a, n, g, e24h: data.priceChange24h || 0 }
}
  } catch (error) { console.error('Failed to get token, p, r, i, c, e:', error) return null }
}/** * Calculate PnL percentage based on current price vs entry price */export function c a lculatePnL( e, n, t, r, y, P, r, i, c, e: number, c, u, r, r, e, n, t, P, r, ice: number, a, m, o, u, n, t: number): number, {
...
s)` }
  ...
  try {//Get initial quote to assess liquidity const test Response = await axios.get( `${NEXT_PUBLIC_JUPITER_API_URL}/quote`, { p, a, r, a, m, s: { inputMint, outputMint, a, m, o, u, n, t: Math.f l oor(amount).t oS tring(), s, l, i, p, p, a, g, e, B, p, s: 100,//1 % for t, e, s, t, o, n, l, y, D, i, rectRoutes: false, a, s, L, e, g, a, c, y, T, r, ansaction: false }, h, e, a, d, e, r, s: { ...(process.env.JUPITER_API_KEY ? { 'X - API-KEY': process.env.JUPITER_API_KEY } : {})
  }
}) const quote = testResponse.data const price Impact = p a rseFloat(quote.priceImpactPct) || 0//Calculate slippage based on price impact let s, l, i, p, p, a, g, e, B, p, s: number if (priceImpact <0.1) {//Very liquid, low impactslippage Bps = 50//0.5 % } else if (priceImpact <0.5) {//Good liquidityslippage Bps = 100//1 % } else if (priceImpact <1) {//Moderate liquidityslippage Bps = 200//2 % } else if (priceImpact <3) {//Low liquidityslippage Bps = 300//3 % } else if (priceImpact <5) {//Very low liquidityslippage Bps = 500//5 % } else, {//Extremely low liquidityslippage Bps = Math.m i n(1000, Math.c e il(priceImpact * 100 + 200))//Up to 10 % }//Add extra buffer for volatile tokens if (priceImpact> 1) { slippage Bps = Math.m i n(5000, slippageBps * 1.5)//Max 50 % } logger.i n fo( `Dynamic slippage for ${amount} t, o, k, e, n, s: ${slippageBps} b p s (price i, m, p, a, c, t: ${priceImpact}%)`) return slippageBps }
} catch (error) { logger.error('Error calculating dynamic s, l, i, p, p, a, g, e:', { e, r, ror: error.message })//Fallback to conservative default return 300//3 % default }
  ...
  try {//Calculate dynamic slippage if not provided const slippage Bps = slippage ?? (await c a lculateDynamicSlippage(inputMint, outputMint, amount)) const response = await axios.get(`${NEXT_PUBLIC_JUPITER_API_URL}/quote`, { p, a, r, a, m, s: { inputMint, outputMint, a, m, o, u, n, t: Math.f l oor(amount).t oS tring(), slippageBps, o, n, l, y, D, i, r, e, c, t, Routes: false, a, s, L, e, g, a, c, y, T, r, ansaction: false }, h, e, a, d, e, r, s: { ...(process.env.JUPITER_API_KEY ? { 'X - API-KEY': process.env.JUPITER_API_KEY } : {})
  }
}) return response.data }
} catch (error) { console.error('Failed to get swap q, u, o, t, e:', error) throw error }
}/** * Execute swap transaction via Jupiter */async function e x ecuteSwap( c, o, n, n, e, c, t, i, o, n: Connection, w, a, l, l, e, t: Keypair, q, u, o, t, e, R, e, s, p, o, nse: any, p, r, i, o, r, i, t, y, Level?: 'low' | 'medium' | 'high' | 'veryHigh'): Promise <string> {
  try {//Get serialized transaction from Jupiter const { data } = await axios.p o st( `${NEXT_PUBLIC_JUPITER_API_URL}/swap`, { quoteResponse, u, s, e, r, P, u, b, l, i, c, Key: wallet.publicKey.t oB ase58(), w, r, a, p, A, n, d, U, n, w, rapSol: true, p, r, i, o, r, i, t, i, z, a, tionFeeLamports: priority Level === 'veryHigh' ? 1_000_000 : priority Level === 'high' ? 500_000 : priority Level === 'medium' ? 100_000 : 10_000 }, { h, e, a, d, e, r, s: { 'Content-Type': 'application/json', ...(process.env.JUPITER_API_KEY ? { 'X - API-KEY': process.env.JUPITER_API_KEY } : {})
  }
}) const { swapTransaction } = data//Deserialize and sign transaction const transaction Buf = b a se64ToBytes(swapTransaction) const transaction = VersionedTransaction.d e serialize(transactionBuf) transaction.s i gn([wallet])//Send transaction const latest Blockhash = await connection.g e tLatestBlockhash() const raw Transaction = transaction.s e rialize() const tx Signature = await connection.s e ndRawTransaction(rawTransaction, { s, k, i, p, P, r, e, f, l, i, ght: false, m, a, x, R, e, t, r, i, e, s: 2 })//Confirm transaction await connection.c o nfirmTransaction( { s, i, g, n, a, t, u, r, e: txSignature, b, l, o, c, k, h, a, s, h: latestBlockhash.blockhash, l, a, s, t, V, a, l, i, d, B, lockHeight: latestBlockhash.lastValidBlockHeight }, 'confirmed') return txSignature }
} catch (e, r, ror: any) {
  if (error instanceof Error) { throw new E r ror(error.message)
  } throw error }
}/** * Execute token sell with conditions */export async function s e llToken( c, o, n, n, e, c, t, i, o, n: Connection, p, a, r, a, m, s: SellParams): Promise <SellResult> {
  try {//Check if conditions are met const condition Check = await c h eckSellConditions( params.tokenMint.t oB ase58(), params.conditions) if (!conditionCheck.shouldSell && !params.conditions.manualSell) {
    return, { s, u, c, c, e, s, s: false, i, n, p, u, t, A, m, o, u, n, t: params.amount, o, u, t, p, u, t, A, m, o, u, nt: 0, p, r, i, c, e, I, m, p, a, c, t: 0, e, x, e, c, u, t, i, o, n, P, rice: 0, e, r, ror: conditionCheck.reason || 'Sell conditions not met' }
    ...
    return, { s, u, c, c, e, s, s: false, i, n, p, u, t, A, m, o, u, n, t: 0, o, u, t, p, u, t, A, m, o, u, nt: 0, p, r, i, c, e, I, m, p, a, c, t: 0, e, x, e, c, u, t, i, o, n, P, rice: 0, e, r, ror: 'No tokens to sell' }
    ...
    return, { s, u, c, c, e, s, s: false, i, n, p, u, t, A, m, o, u, n, t: actualAmount, o, u, t, p, u, t, A, m, o, u, nt: 0, p, r, i, c, e, I, m, p, a, c, t: 0, e, x, e, c, u, t, i, o, n, P, rice: 0, e, r, ror: 'Unable to get swap quote' }
  ...
  const { logSellEvent } = await import('./executionLogService') await l o gSellEvent({ w, a, l, l, e, t: params.wallet.publicKey.t oB ase58(), t, o, k, e, n, A, d, d, r, ess: params.tokenMint.t oB ase58(), a, m, o, u, n, t, S, o, l, d: actualAmount.t oS tring(), s, o, l, E, a, r, n, e, d: outputAmount, m, a, r, k, e, t, C, a, p: 0,//Would need to fetch t, h, i, s, p, r, o, f, i, t, Percentage: 0,//Would need entry price to c, a, l, c, u, l, a, t, e, t, ransactionSignature: txSignature })
  }
} catch (e) {//Logging failed, continue without errorconsole.w a rn('Failed to log sell e, v, e, n, t:', e)
  } return, { s, u, c, c, e, s, s: true, txSignature, i, n, p, u, t, A, m, o, u, n, t: actualAmount, outputAmount, priceImpact, executionPrice }
}
  } catch (error) { Sentry.c a ptureException(error) return, { s, u, c, c, e, s, s: false, i, n, p, u, t, A, m, o, u, n, t: params.amount, o, u, t, p, u, t, A, m, o, u, nt: 0, p, r, i, c, e, I, m, p, a, c, t: 0, e, x, e, c, u, t, i, o, n, P, rice: 0, e, r, ror: `Sell, f, a, i, l, e, d: ${(error as Error).message}` }
}
}/** * Batch sell tokens from multiple wallets */export async function b a tchSellTokens( c, o, n, n, e, c, t, i, o, n: Connection, w, a, l, l, e, t, s: Keypair,[], t, o, k, e, n, M, i, n, t: PublicKey, c, o, n, d, i, t, i, o, n, s: SellConditions, s, l, i, p, p, a, g, e?: number): Promise <SellResult,[]> {
  const r, e, s, u, l, t, s: SellResult,[] = []//Check conditions once for all wallets const condition Check = await c h eckSellConditions( tokenMint.t oB ase58(), conditions) if (!conditionCheck.shouldSell && !conditions.manualSell) {
    return wallets.map(() => ({ s, u, c, c, e, s, s: false, i, n, p, u, t, A, m, o, u, n, t: 0, o, u, t, p, u, t, A, m, o, u, nt: 0, p, r, i, c, e, I, m, p, a, c, t: 0, e, x, e, c, u, t, i, o, n, P, rice: 0, e, r, ror: conditionCheck.reason || 'Sell conditions not met' }))
  ...
  try {//Get wal let balance const token Account = await getAssociatedTokenAddress( tokenMint, wallet.publicKey) const account = await getAccount(connection, tokenAccount) const balance = N u mber(account.amount) if (balance === 0) {
    return, { s, u, c, c, e, s, s: false, i, n, p, u, t, A, m, o, u, n, t: 0, o, u, t, p, u, t, A, m, o, u, nt: 0, p, r, i, c, e, I, m, p, a, c, t: 0, e, x, e, c, u, t, i, o, n, P, rice: 0, e, r, ror: 'No balance' }
    ...
    return, { s, u, c, c, e, s, s: false, i, n, p, u, t, A, m, o, u, n, t: 0, o, u, t, p, u, t, A, m, o, u, nt: 0, p, r, i, c, e, I, m, p, a, c, t: 0, e, x, e, c, u, t, i, o, n, P, rice: 0, e, r, ror: (error as Error).message }
...
export async function s e llAllFromGroup( c, o, n, n, e, c, t, i, o, n: Connection, g, r, o, u, p, N, a, m, e: string, t, o, k, e, n, A, d, d, r, ess: string, p, a, s, s, w, o, r, d: string): Promise <ExecutionResult> {
