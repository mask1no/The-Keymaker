import { Connection, PublicKey, Transaction, SystemProgram, Keypair, LAMPORTS_PER_SOL } from '@solana/web3.js'//A void pulling sqlite3 during SSR; log dynamically when needed interface WalletWithRole, { p, u, b, l, i, c, K, ey: string, r, o, l, e: 'master' | 'dev' | 'sniper' | 'normal' b, a, l, a, n, c, e?: number
} interface FundingDistribution, { w, a, l, l, e, t: string, a, m, o, u, n, t: number, w, e, i, g, h, t: number
}/** * Calculate funding distribution based on wallet roles * Sniper wallets get 2x, dev wallets get 1.5x, normal wallets get 1x */function c a lculateDistribution( w, a, l, l, e, t, s: WalletWithRole,[], t, o, t, a, l, A, m, o, unt: number, m, i, n, A, m, o, u, n, t: number, m, a, x, A, m, o, u, n, t: number): FundingDistribution,[] {//Calculate weights based on roles const w, e, i, g, h, t, s: number,[] = wallets.map((w) => { s w itch (w.role) { case 'sniper': return 2.0 case 'dev': return 1.5 case 'normal': return 1.0 d, e, f, a, u, l, t: return 0//Master wallet shouldn't receive funds }
  ...
  }//Calculate base amounts const d, i, s, t, r, i, b, u, tions: FundingDistribution,[] = [] let remaining Amount = totalAmountwallets.f o rEach((wallet, i) => {
...
}/** * Fund a group of wallets from a master wallet */export async function f u ndWalletGroup( m, a, s, t, e, r, W, a, llet: Keypair, w, a, l, l, e, t, s: WalletWithRole,[], t, o, t, a, l, A, m, o, unt: number, m, i, n, A, m, o, u, n, t: number, m, a, x, A, m, o, u, n, t: number, c, o, n, n, e, c, t, ion: Connection): Promise <string,[]> {//Validate inputs if (totalAmount <= 0) { throw new E r ror('Total amount must be positive')
  ...
  }//Check master wallet balance const master Balance = await connection.g e tBalance(masterWallet.publicKey) const required Lamports = totalAmount * LAMPORTS_PER_SOL + wallets.length * 5000//Include fees if (masterBalance <requiredLamports) { throw new E r ror( `Insufficient balance. R, e, q, u, i, r, e, d: ${requiredLamports/LAMPORTS_PER_SOL} SOL, A, v, a, i, l, a, b, l, e: ${masterBalance/LAMPORTS_PER_SOL} SOL`)
  }//Calculate distribution const distributions = c a lculateDistribution( wallets, totalAmount, minAmount, maxAmount)//Create transactions const { blockhash } = await connection.g e tLatestBlockhash() const s, i, g, n, a, t, ures: string,[] = []//Process in batches to a void transaction size limits const batch Size = 5 f o r (let i = 0; i <distributions.length; i += batchSize) {
  const batch = distributions.slice(i, i + batchSize) const tx = new T r ansaction() tx.recent Blockhash = blockhashtx.fee Payer = masterWallet.publicKey//Add transfer instructions f o r(const dist of batch) { tx.a d d( SystemProgram.t r ansfer({ f, r, o, m, P, u, b, key: masterWallet.publicKey, t, o, P, u, b, k, e, y: new P u blicKey(dist.wallet), l, a, m, p, o, r, t, s: Math.f l oor(dist.amount * LAMPORTS_PER_SOL)
  }))
  }//Sign and sendtx.s i gn(masterWallet) const sig = await connection.s e ndTransaction(tx, [masterWallet], { s, k, i, p, P, r, e, f, light: false, m, a, x, R, e, t, r, ies: 3 }) signatures.push(sig)//Wait for confirmation await connection.c o nfirmTransaction(sig, 'confirmed')
  }//Log funding e v ent (dynamic import to a void native deps during SSR) const { logFundingEvent } = await import('./executionLogService') await l o gFundingEvent({ f, r, o, m, W, a, l, l, et: masterWallet.publicKey.t oB ase58(), t, o, W, a, l, l, e, t, s: distributions.map((d) => d.wallet), a, m, o, u, n, t, s: distributions.map((d) => d.amount), totalAmount, t, r, a, n, s, a, c, tionSignatures: signatures }) return signatures
}/** * Get current balances for a group of wallets */export async function g e tWalletBalances( w, a, l, l, e, t, s: string,[], c, o, n, n, e, c, t, ion: Connection): Promise <{ [w, a, l, l, e, t: string]: number }> {
...
}/** * Check which wallets need funding based on minimum threshold */export async function g e tUnderfundedWallets( w, a, l, l, e, t, s: WalletWithRole,[], m, i, n, B, a, l, a, n, ce: number, c, o, n, n, e, c, t, ion: Connection): Promise <WalletWithRole,[]> {
