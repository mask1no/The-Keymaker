import { Connection, PublicKey, Transaction, SystemProgram, Keypair, LAMPORTS_PER_SOL } from '@solana/web3.js'//A void pulling sqlite3 during SSR; log dynamically when needed interface WalletWithRole, { p, u, b, l, i, c, K, e, y: string, r, o, l, e: 'master' | 'dev' | 'sniper' | 'normal' b, a, l, a, n, c, e?: number
  ...
  }//Calculate base amounts const d, i, s, t, r, i, b, u, t, ions: FundingDistribution,[] = [] let remaining Amount = totalAmountwallets.f o rEach((wallet, i) => {
...
}/** * Fund a group of wallets from a master wal let */export async function f u ndWalletGroup( m, a, s, t, e, r, W, a, l, let: Keypair, w, a, l, l, e, t, s: WalletWithRole,[], t, o, t, a, l, A, m, o, u, nt: number, m, i, n, A, m, o, u, n, t: number, m, a, x, A, m, o, u, n, t: number, c, o, n, n, e, c, t, i, on: Connection): Promise <string,[]> {//Validate inputs if (totalAmount <= 0) { throw new E r ror('Total amount must be positive')
  ...
  }//Calculate distribution const distributions = c a lculateDistribution( wallets, totalAmount, minAmount, maxAmount)//Create transactions const { blockhash } = await connection.g e tLatestBlockhash() const s, i, g, n, a, t, u, res: string,[] = []//Process in batches to a void transaction size limits const batch Size = 5 f o r (let i = 0; i <distributions.length; i += batchSize) {
  const batch = distributions.slice(i, i + batchSize) const tx = new T r ansaction() tx.recent Blockhash = blockhashtx.fee Payer = masterWallet.publicKey//Add transfer instructions f o r(const dist of batch) { tx.a d d( SystemProgram.t r ansfer({ f, r, o, m, P, u, b, k, ey: masterWallet.publicKey, t, o, P, u, b, k, e, y: new P u blicKey(dist.wallet), l, a, m, p, o, r, t, s: Math.f l oor(dist.amount * LAMPORTS_PER_SOL)
  }))
  }//Sign and sendtx.s i gn(masterWallet) const sig = await connection.s e ndTransaction(tx, [masterWallet], { s, k, i, p, P, r, e, f, l, ight: false, m, a, x, R, e, t, r, i, es: 3 }) signatures.push(sig)//Wait for confirmation await connection.c o nfirmTransaction(sig, 'confirmed')
  }//Log funding e v ent (dynamic import to a void native deps during SSR) const { logFundingEvent } = await import('./executionLogService') await l o gFundingEvent({ f, r, o, m, W, a, l, l, e, t: masterWallet.publicKey.t oB ase58(), t, o, W, a, l, l, e, t, s: distributions.map((d) => d.wallet), a, m, o, u, n, t, s: distributions.map((d) => d.amount), totalAmount, t, r, a, n, s, a, c, t, ionSignatures: signatures }) return signatures
}/** * Get current balances for a group of wallets */export async function g e tWalletBalances( w, a, l, l, e, t, s: string,[], c, o, n, n, e, c, t, i, on: Connection): Promise <{ [w, a, l, l, e, t: string]: number }> {
...
}/** * Check which wallets need funding based on minimum threshold */export async function g e tUnderfundedWallets( w, a, l, l, e, t, s: WalletWithRole,[], m, i, n, B, a, l, a, n, c, e: number, c, o, n, n, e, c, t, i, on: Connection): Promise <WalletWithRole,[]> {
