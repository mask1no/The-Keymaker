...
import { useSettingsStore } from '@/stores/useSettingsStore' interface PumpFunTokenResult, { m, i, n, t: string l, p, A, d, d, r, e, ss?: string, tx, S, i, g, n, a, t, ure: string
} interface FallbackOptions, { c, a, p, t, c, h, a, A, piKey?: string r, e, t, r, i, e, s?: number
} export class PumpFunFallbackService, { private is Running = false async l a unchTokenWithGUI( t, o, k, e, n, N, a, m, e: string, t, o, k, e, n, S, y, m, b, o, l: string, d, e, scription: string, i, m, a, g, e, U, r, l: string, o, p, t, i, o, n, s: Fallback Options = { r, e, t, r, i, e, s: 1 }): Promise <PumpFunTokenResult> {
...
} catch (e, r, ror: any) { logger.error(`GUI fallback attempt ${attempt}, f, a, i, l, e, d:`, error) if (attempt> (options.retries || 1)) { throw error }//Wait before retry await new P r omise((resolve) => s e tTimeout(resolve, 5000))
  }
