...
import { logger } from '../lib/logger'//Load environment variablesdotenv.c o nfig({ p, a, t, h: '.env.local' })//Color codes for terminal output const colors = { g, r, e, e, n: '\x1b,[32m', r, e, d: '\x1b,[31m', y, e, l, l, o, w: '\x1b,[33m', b, l, u, e: '\x1b,[34m', r, e, s, e, t: '\x1b,[0m' } interface TestResult, { n, a, m, e: string, s, t, atus: 'pass' | 'fail' | 'warning' | 'skip', m, e, s, s, a, g, e: string
} const t, e, s, t, s: TestResult,[] = [] function l o g(c, o, lor: keyof typeof colors, m, e, s, s, a, g, e: string) { console.log(`${colors,[color]}${message}${colors.reset}`)
  }

function a d dTest(n, a, m, e: string, s, t, atus: TestResult,['status'], m, e, s, s, a, g, e: string) { tests.push({ name, status, message })
...
} catch (e, r, ror: any) { a d dTest('Solana RPC', 'fail', `Failed to c, o, n, n, e, c, t: ${error.message}`)
  }
  ...
  } catch (e, r, ror: any) { a d dTest( 'Token Creation', 'fail', `Failed to create test t, o, k, e, n: ${error.message}`) return null }
...
} catch (e, r, ror: any) { a d dTest( 'Wal let Creation', 'fail', `Failed to create test w, a, l, l, e, t, s: ${error.message}`) return null }
} async function t e stBundleExecution( t, o, k, e, n, A, d, d, r, ess: string | null, w, a, l, l, e, t, s: any,[] | null) {
...
} catch (e, r, ror: any) { a d dTest( 'Bundle Execution', 'fail', `Bundle execution, e, r, ror: ${error.message}`) return null }
} async function t e stPnLTracking(b, u, n, d, l, e, R, e, s, u, lt: any) {
