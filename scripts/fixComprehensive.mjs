...
const comprehensiveFixes = [
  ...
  [/export\s+async\s+function\s+GET\([^)]*\)\s*\{/g, 'export async function GET(request: Request) {'],
  [/export\s+async\s+function\s+POST\([^)]*\)\s*\{/g, 'export async function POST(request: Request) {'],
  [/export\s+async\s+function\s+PUT\([^)]*\)\s*\{/g, 'export async function PUT(request: Request) {'],
  [/export\s+async\s+function\s+DELETE\([^)]*\)\s*\{/g, 'export async function DELETE(request: Request) {'],
  [/export\s+async\s+function\s+PATCH\([^)]*\)\s*\{/g, 'export async function PATCH(request: Request) {'],
