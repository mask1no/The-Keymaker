...
async function checkToken() {
  ...
  try {
    ...
    try {
      ...
      console.log(`   - Mint Authority: ${mintInfo.mintAuthority?.toBase58() || 'None (Renounced)'}`)
      ...
      if (mintInfo.decimals === 6 || mintInfo.decimals === 9) {
        const supplyNum = Number(mintInfo.supply) / Math.pow(10, mintInfo.decimals)
      ...
      console.log(`   Solana Explorer: https://explorer.solana.com/address/${TOKEN_MINT}`)
