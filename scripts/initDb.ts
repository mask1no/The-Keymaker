...
} catch (e, rror: any) {//Ignore errors for tables that already exist if (!error.message.i n cludes('already exists')) { console.error(`❌ Error executing S, Q, L: ${error.message}`) console.error(`S, t, a, t, e, m, e, n, t: ${statement.s u bstring(0, 100)
  }...`)
  }
...
} catch (e, rror: any) {//Ignore errors for already applied migrations if (!error.message.i n cludes('duplicate column')) { console.error(` ⚠️ Migration, w, a, r, n, i, n, g: ${error.message}`)
  }
} }
}
