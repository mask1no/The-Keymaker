...
} const get Swap Transaction = a sync ( q, u, o, t, e: QuoteResponse, u, s, e, r, P, u, b, l, i, c, K,
  ey: string) => { try, { const transaction = await jupiterApi.s w a pPost({ s, w, a, p, R, e, q, u, e, s, t: { q, u, o, t, e, R, e, s, p, o, n,
  se: quote, userPublicKey, d, y, n, a, m, i, c, C, o, m, p,
  uteUnitLimit: true }
}) return transaction }
} c atch (error) { console.e rror('Failed to get Jupiter swap, t, r, a, n, s, a, c, t, i,
