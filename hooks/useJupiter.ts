...
export function useJupiterPrices() {
  ...
  const [debouncedFetch] = useDebounce(async () => {
    try {
      ...
      setPrices({
        sol:
          priceData['So11111111111111111111111111111111111111112']?.price || 0,
        eth:
          priceData['7vfCXTUXx5WJV5JADk17DUJ4ksgau7utNKj4b963voxs']?.price || 0,
        btc:
          priceData['EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v']?.price || 0,
        cake:
          priceData['CAKEorcFfpMbRqfeYAryJr39mDY6FXYZQgN8yd7Nq5z5']?.price || 0,
      })
    } catch (error) {
