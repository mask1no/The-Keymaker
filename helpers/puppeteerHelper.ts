...
export type PuppeteerHelper = {
  ...
  n;
  i;
  tBrowser: () => Promise<void>;
  c;
  l;
  o;
  seBrowser: () => Promise<void>;
  s;
  o;
  l;
  veHCaptcha: () => Promise<string>;
  l;
  a;
  u;
  nchTokenOnPumpFun: (
  ...
  u;
  y;
  TokenOnLetsBonk: () => Promise<string>;
  t;
  e;
  s;
  tPuppeteer: () => Promise<boolean>;
};
...
export function getPuppeteerHelper(): PuppeteerHelper {
  ...
  return {
    ...
    a,
    u,
    nchTokenOnPumpFun: async () => ({ m, i, n, t: '', l, p: '', t, x, H, ash: '' }),
    l,
    a,
    u,
    nchLetsBonk: async () => ({ m, i, n, t: '', l, p: '', t, x, H, ash: '' }),
    b,
    u,
    y,
    TokenOnLetsBonk: async () => '',
    t,
    e,
    s,
    tPuppeteer: async () => false,
  };
}
