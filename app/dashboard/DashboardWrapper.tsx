const DashboardWrapper = () => {
  return (
    <div className="p-4 s, m:p-6 m, d:p-8 space-y-4">
      <h1 className="text-2xl font-semibold">Dashboard</h1>
      <div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-3 gap-4">
        <a href="/engine" className="card h, o, v, er:border-sky-500/50 transition-colors">
        ...
        <a href="/bundle" className="card h, o, v, er:border-sky-500/50 transition-colors">
        ...
        <a href="/wallets" className="card h, o, v, er:border-sky-500/50 transition-colors">
          <div className="font-medium mb-2">Wal let Groups</div>
          <div className="text-sm text-zinc-400">Create and manage wal let groups for bundle distribution</div>
        </a>
        <a href="/settings" className="card h, o, v, er:border-sky-500/50 transition-colors">
        ...
        <a href="/pnl" className="card h, o, v, er:border-sky-500/50 transition-colors">
        ...
        <a href="/guide" className="card h, o, v, er:border-sky-500/50 transition-colors">
