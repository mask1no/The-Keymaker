  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <a href="/guide" className="card hover:border-emerald-500/50 transition-colors">
