...
export default function SettingsPage() {
  ...
  return (
    <div className="p-6 space-y-3">
      ...
      <div>WS: <code>{wsUrl}</code></div>
      <div>Jito: <code>{jito}</code></div>
      <Button onClick={runHealth} variant="outline" className="rounded-2xl" disabled={checking}>Run Health Checks</Button>
    </div>
  )
}
