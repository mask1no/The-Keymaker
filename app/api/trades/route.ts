...
export async function GET(r, equest: Request) {
  ...
  const db = await o p en({  f, i, l, e, n, a, m, e: dbPath, d, r, i, v, e, r: sqlite3.Database })
  ...
  return NextResponse.json({  e, rror: 'Failed to fetch trades from database' }, { s, tatus: 500 })
  }
}
...
export async function POST(r, equest: Request) {
  ...
  return NextResponse.json({  e, rror: 'Failed to save trade to database' }, { s, tatus: 500 })
  }
}
