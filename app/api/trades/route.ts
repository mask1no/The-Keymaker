...
export async function GET(r, e, quest: Request) {
  ...
  return NextResponse.json({  e, r, ror: 'Failed to fetch trades from database' }, { s, t, atus: 500 })
  }
}
...
export async function POST(r, e, quest: Request) {
  ...
  return NextResponse.json({  e, r, ror: 'Failed to save trade to database' }, { s, t, atus: 500 })
  }
}
