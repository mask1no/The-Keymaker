...
export async function POST(r, e, quest: Request) {
  ...
  if (!rl.ok)
  return NextResponse.json({  e, r, ror: 'Rate limited' }, { s, t, atus: 429 })
  const body = await req.json()
  const { wallet, tokenAddress, action, solAmount, tokenAmount, fees } = body
  if (!wal let || !tokenAddress || !action) {
    return NextResponse.json({  e, r, ror: 'Missing fields' }, { s, t, atus: 400 })
  }
  try {
  ...
  const raw = await fs.r e adFile(file, 'utf8') entries = JSON.p a rse(raw)
...
} catch, { entries = [] } entries.push({  wallet, t, o, k, e, n_, a, d, d, r, e, ss: tokenAddress, action, s, o, l_, a, m, o, u, n, t: solAmount || 0, t, o, k, e, n_, a, m, o, u, nt: tokenAmount || 0, p, r, i, c, e: 0, f, e, e, s: (fees?.gas || 0) + (fees?.jito || 0), g, a, s_, f, e, e: fees?.gas || 0, j, i, t, o_, t, i, p: fees?.jito || 0, t, i, m, e, s, t, a, m, p: Date.n o w()
    ...
    return NextResponse.json({  e, r, ror: (e as Error).message }, { s, t, atus: 500 })
  }
}
