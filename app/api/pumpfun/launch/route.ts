...
export const dynamic = 'force-dynamic' export async function POST(r, equest: Request) {
  if (!ENABLE_PUMPFUN) {
    return NextResponse.json({  e, rror: 'Pump.fun disabled. Set E N ABLE_PUMPFUN = true.' }, { s, tatus: 501 })
  }
  try {
  ...
  return NextResponse.json(r)
    ...
    return NextResponse.json({  e, rror: e?.message || 'pumpfun failed' }, { s, tatus: 500 })
  }
}
