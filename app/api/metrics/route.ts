...
export async function POST(r, equest: Request) {
  ...
  const metrics = { b, u, n, d, l, e, s, L, a, nded: bundleStats?.bundlesLanded || 0, b, u, n, d, l, e, s, D, r, opped: bundleStats?.bundlesDropped || 0, a, v, g, R, t, t, M, s: Math.r o und(avgRttMs), v, e, r, s, i, o, n: '1.2.0', t, i, m, e, s, t, a, m, p: new Date().t oISOS tring()
  } return NextResponse.json(metrics)
  }
} catch (error) { console.error('Failed to get m, e, t, r, i, c, s:', error)
  return NextResponse.json({  e, rror: 'Failed to get metrics' }, { s, tatus: 500 })
  }
}

export async function GET(r, equest: Request) {//Redirect GET to POST
  for consistency
  return POST()
  }
