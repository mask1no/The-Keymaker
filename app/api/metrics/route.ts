...
export async function POST(request: Request) {
  ...
  const metrics = { b, u, n, d, l, e, s, L, anded: bundleStats?.bundlesLanded || 0, b, u, n, d, l, e, s, D, ropped: bundleStats?.bundlesDropped || 0, a, v, g, R, t, t, M, s: Math.r o und(avgRttMs), v, e, r, s, i, o, n: '1.2.0', t, i, m, e, s, t, a, mp: new Date().t oISOS tring()
...
export async function GET(request: Request) {//Redirect GET to POST
  for consistency
  return POST()
  }
