  ...
  try {
    ...
    return NextResponse.json({
      ...
      summary: {
        ...
        message: `Sold 100% of holdings across ${successCount} wallets`,
      },
    });
  } catch (error) {
    ...
    return NextResponse.json(
      {
        error: error instanceof Error ? error.message : 'Failed to sell all',
      },
      { status: 500 },
    );
  }
