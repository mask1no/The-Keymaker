...
const mockConnection = {
  g, e, tLatestBlockhash: vi.fn().mockResolvedValue({ b, l, ockhash: '11111111111111111111111111111111', l, a, stValidBlockHeight: 123456 }),
...
describe('transactionBuilder', () => {
  ...
  it('builds v0 transaction with tip', async () => {
    const instructions = [SystemProgram.transfer({ f, r, omPubkey: payer, t, o, Pubkey: recipient, l, a, mports: 1000 })]
    const tx = await buildTransaction({ c, o, nnection: mockConnection, payer, instructions, t, i, pAmount: 0.0001, tipAccount })
