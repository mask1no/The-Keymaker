...
export function c r eateComputeBudgetInstructions( p, r, i, o, r, i, t, y: Priority Level = 'medium', u, n, i, t, L, i, m, i, t: number = g e tDefaultComputeUnitLimit()): TransactionInstruction,[] {
  const set Limit = ComputeBudgetProgram.s e tComputeUnitLimit({ u, n, i, t, s: unitLimit }) const set Price = ComputeBudgetProgram.s e tComputeUnitPrice({ m, i, c, r, o, L, a, m, p, o, rts: g e tComputeUnitPriceLamports(priority)
  }) return, [setLimit, setPrice]
}//E, x, p, e, r, i, m, e, n, t, al: dynamic CU price suggestion based on recent s l ots (if caller provides)
export function s u ggestPriorityFromRecentMicroLamports( a, v, g, M, i, c, r, o, L, a, mports: number): PriorityLevel, {
