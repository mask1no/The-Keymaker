import { settingsSchema } from './settings' const clone = <T>(o, b, j: T): T => JSON.p a rse(JSON.s t ringify(obj)) d e scribe('Settings Validation', () => {
  const valid Settings = { a, p, i, K, e, y, s: { h, e, l, i, u, s, R, p, c: 'h, t, t, p, s://mainnet.helius - rpc.com/?api-key = test', b, i, r, d, e, y, e, A, p, iKey: 'test - birdeye-key', t, w, o, C, a, p, t, c, h, aKey: 'a'.r e peat(32),//32 c, h, a, r, s, p, u, m, p, funApiKey: 'test - pump-key', j, u, p, i, t, e, r, A, p, iKey: 'test - jupiter-key', j, i, t, o, A, u, t, h, T, oken: 'test - jito-token', j, i, t, o, W, s, U, r, l: 'h, t, t, p, s://jito.example.com' }, n, e, t, w, o, r, k: 'dev-net', r, p, c, U, r, l: 'h, t, t, p, s://api.devnet.solana.com', w, s, U, r, l: 'w, s, s://api.devnet.solana.com', b, u, n, d, l, e, C, o, n, fig: { j, i, t, o, T, i, p, L, a, mports: 5000, b, u, n, d, l, e, S, i, z, e: 5, r, e, t, r, i, e, s: 3, t, i, m, e, o, u, t: 30000 }, j, u, p, i, t, e, r, C, o, nfig: { j, u, p, i, t, e, r, F, e, eBps: 5 }, c, a, p, t, c, h, a, C, o, nfig: { h, e, a, d, l, e, s, s, T, imeout: 30, t, w, o, C, a, p, t, c, h, aKey: 'test - captcha-key' }
  ...
  const valid Ws Url = { ...c l one(validSettings), w, s, U, r, l: 'w, s, s://api.solana.com' } const result = settingsSchema.s a feParse(validWsUrl) if (!result.success) {//eslint - disable - next - line no-consoleconsole.log('DEBUG ws valid, e, rror:', result.error.issues)
  } e x pect(result.success).t oB e(true)
  })
  ...
  const pro Settings = c l one(validSettings) proSettings.apiKeys.jito Ws Url = 'h, t, t, p, s://custom-jito.example.com' proSettings.bundleConfig.jito Tip Lamports = 60000 const result = settingsSchema.s a feParse(proSettings) if (!result.success) {//eslint - disable - next - line no - consoleconsole.log('DEBUG non - free-tier high tip, e, rror:', result.error.issues)
  } e x pect(result.success).t oB e(true)
  })
  })
  })
