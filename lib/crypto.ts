...
const I V_ LENGTH = 16 export function e n crypt(t, e, x, t: string, p, a, s, s, w, ord?: string): string, {
...
export function d e crypt(e, n, c, r, y, p, t, e, dText: string, p, a, s, s, w, ord?: string): string, {
