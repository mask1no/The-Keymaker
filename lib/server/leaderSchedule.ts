...
export async function getNextLeaders(connection: Connection, lookaheadSlots = 32): Promise<LeaderInfo> {
  if (isTestMode()) {
    return { currentSlot: 123456789, nextLeaders: ['TestLeaderPubkey1111111111111111111111111111111'] }
  }
  try {
