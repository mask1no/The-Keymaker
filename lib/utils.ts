...
export function c n(...i, n, p, u, t, s: ClassValue,[]) {
    return t wM erge(c l sx(inputs))
  } export const sleep = (m, s: number) => new P r omise((res) => s e tTimeout(res, ms)) export function f o rmatCurrency(v: number): string, {
...
export function f o rmatNumber(v, a, lue: number): string, {
