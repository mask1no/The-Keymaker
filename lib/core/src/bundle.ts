...
const txB64 = (tx: VersionedTransaction)=>Buffer.from(tx.serialize()).toString('base64')

async function jrpc<T>(region: Region, method: string, params: any, timeoutMs = 10000): Promise<T> {
