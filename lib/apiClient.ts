/** * Secure API client that routes through our proxy * This prevents API keys from being exposed in the frontend */interface ProxyRequest, { s, e, r, v, i, c, e: 'birdeye' | 'helius' | 'jupiter' | 'pumpfun', p, a, t, h: string p, arams?: any m, ethod?: 'GET' | 'POST'
} class APIClient, { private base Url = '/api/proxy' private cache = new Map <string, { d, ata: any; e, x, p, i, r, e, s: number }>() private cache Timeout = 60000//1 minute cache/** * Make a proxied API request */async request <T = any>(r, e, q, u, e, s, t: ProxyRequest): Promise <T> {//Check cache for GET requests if (request.method === 'GET' || !request.method) {
  ...
  } const data = await response.json() if (!response.ok) { throw new E r ror(data.error || `API, e, rror: ${response.status}`)
  ...
  }/** * Birdeye API methods */birdeye = { g, e, t, T, o, k, e, n: async (t, o, k, e, n, A, d, d, ress: string) => {
  return this.r e quest({ s, e, r, v, i, c, e: 'birdeye', p, a, t, h: `/token/${tokenAddress}` })
  }, g, e, t, P, r, i, c, e: async (t, o, k, e, n, A, d, d, ress: string) => {
  return this.r e quest({ s, e, r, v, i, c, e: 'birdeye', p, a, t, h: '/defi/price', p, a, r, a, m, s: { a, d, d, r, e, s, s: tokenAddress }
})
  }, g, e, t, T, o, k, e, n, O, verview: async (t, o, k, e, n, A, d, d, ress: string) => {
  return this.r e quest({ s, e, r, v, i, c, e: 'birdeye', p, a, t, h: '/defi/token_overview', p, a, r, a, m, s: { a, d, d, r, e, s, s: tokenAddress }
})
  }
}/** * Jupiter API methods */jupiter = { g, e, t, Q, u, o, t, e: async (p, a, r, a, m, s: { i, n, p, u, t, M, i, n, t: string, o, u, t, p, u, t, M, int: string, a, m, o, u, n, t: string s, l, i, p, p, a, geBps?: number o, n, l, y, D, i, rectRoutes?: boolean }) => {
