...
export const NEXT_PUBLIC_HELIUS_RPC = process.env.NEXT_PUBLIC_HELIUS_RPC || 'https://api.mainnet-beta.solana.com'
...
process.env.NEXT_PUBLIC_JITO_ENDPOINT || process.env.JITO_RPC_URL || 'https://mainnet.block-engine.jito.wtf'

//Do not expose server-only API keys in client bundles; use server proxies where needed
...
// Canonical list of Jito tip accounts (static keys)
